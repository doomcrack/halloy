...
pub struct Keyboard {
    ...
    // Keep the IRC-era names as aliases for existing configs
    #[serde(alias = "toggle_nick_list")]
    pub toggle_member_list: KeyBinds,
    #[serde(alias = "toggle_topic")]
    pub toggle_details: KeyBinds,
...
impl Default for Keyboard {
    fn default() -> Self {
        Self {
            ...
            toggle_member_list: KeyBind::toggle_member_list().into(),
            toggle_sidebar: KeyBind::toggle_sidebar().into(),
            toggle_details: KeyBind::toggle_details().into(),
...
impl Keyboard {
    fn keybind_pairs(&self) -> Vec<(&KeyBinds, Command)> {
        ...
        vec![
            ...
            (&self.toggle_member_list, ToggleMemberList),
            (&self.toggle_details, ToggleDetails),
